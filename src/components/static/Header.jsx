...
export default function Header() {
	const [navigation, setNavigation] = useState([
		...
		{ name: "Itinary", href: "/Itinary", current: false },
	...
	{/* insert g-form*/}	<a href="#"> 
							    <button className="text-white text-sm  font-mono font-semibold rounded-full px-2 lg:px-4 py-2 bg-[#cda160]">
													Regesiter 
								</button>	
							</a>							
							</div>
