...
function Compscard(props){
    ...
    <div className=" p-3 bg-opacity-5 backdrop-filter bg-brown-100 backdrop-blur-md mb-3 rounded-2xl ">
        ...
        <a href={props.link}> <button className= "comptextheader font-bold text-2xl text-white flex justify-center px-5 py-2 mb-2 rounded-lg bg-[#BE9D6C]"> Register </button></a>
        </div>
    </div>
