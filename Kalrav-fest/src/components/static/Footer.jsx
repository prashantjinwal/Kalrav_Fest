	...
	return (
		...
		<div className=" flex justify-center  rounded-xl  w-full h-[27em] relative  bg-opacity-5 backdrop-filter bg-brown-50 backdrop-blur-md">
 			<div className="px-5">
				...
				<img  className="" src={process.env.PUBLIC_URL + "/images/text/insta.png"} alt="" />
				<img  className="" src={process.env.PUBLIC_URL + "/images/text/twitter.png"} alt="" />
				<img  className="" src={process.env.PUBLIC_URL + "/images/text/linkdin.png"} alt="" />
				<img  className="" src={process.env.PUBLIC_URL + "/images/text/youtube.png"} alt="" />
